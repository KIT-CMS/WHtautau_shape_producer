...
common_binning = {
    ...
    "pt_1": Histogram("pt_1", "pt_1", np.append(np.array([0]), np.arange(20, 200, 10))),
    "pt_2": Histogram("pt_2", "pt_2", np.append(np.array([0]), np.arange(20, 200, 10))),
    "pt_3": Histogram("pt_3", "pt_3", np.append(np.array([0]), np.arange(20, 200, 10))),
    ...
    "pfmet": Histogram(
        "pfmet", "pfmet", np.append(np.arange(0, 160, 5), np.array([200, 400]))
    ),
