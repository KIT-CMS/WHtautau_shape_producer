...
def VVV_process_selection(channel, era, wp_vs_jet, wp_vs_mu, wp_vs_ele, id_wp_ele, id_wp_mu):
    VVV_process_weights = MC_base_process_selection(channel, era, wp_vs_jet, wp_vs_mu, wp_vs_ele, id_wp_ele, id_wp_mu).weights
    if era == "2016preVFP":
...
def H_process_selection(channel, era, wp_vs_jet, wp_vs_mu, wp_vs_ele, id_wp_ele, id_wp_mu):
    H_process_weights = MC_base_process_selection(channel, era, wp_vs_jet, wp_vs_mu, wp_vs_ele, id_wp_ele, id_wp_mu).weights
