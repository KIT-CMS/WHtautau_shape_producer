...
anti_iso_llt_tau = ReplaceCutAndAddWeight(
    "tau_anti_iso",
    "tau_iso",
    Cut("id_tau_vsJet_Loose_3<0.5&&id_tau_vsJet_VVVLoose_3>0.5", "tau_anti_iso"),
...
anti_isoid_mu_1_tau_var = [
    ReplaceMultipleCutsAndAddWeight(
        ...
        [
            ...
            Cut(
                "(id_tau_vsJet_Tight_3<0.5&&id_tau_vsJet_VVVLoose_3>0.5)",
                "tau_anti_iso",
            ),
        ],
        Weight(
...
anti_isoid_mu_2_tau_var = [
    ReplaceMultipleCutsAndAddWeight(
        ...
        [
            ...
            Cut(
                "(id_tau_vsJet_Loose_3<0.5&&id_tau_vsJet_VVVLoose_3>0.5)",
                "tau_anti_iso",
            ),
        ],
        Weight(
