...
INPUT_FILE="output/shapes/27_01_all_ch/mmt/fakerate_measurement_incl_bveto_ortho_det_reg_AN_binning"
OUTPUT_FILE="friends/jetfakes_lib_tau_incl_bveto_ortho_det_reg_AN_binning_test.json"
PLOT_OUTPUT="plots/27_01_all_ch/jet_to_tau_fakerates_incl_bveto_ortho_det_reg_AN_binning_test"
SYST_UNC=10
mkdir -p ${PLOT_OUTPUT}
...
OUTPUT_FILE="friends/jetfakes_lib_mu_incl_bveto_ortho_det_reg_test.json"
PLOT_OUTPUT="plots/09_02_eem_mme_2/jet_to_mu_fakerates_incl_bveto_ortho_det_reg_test"
mkdir -p ${PLOT_OUTPUT}
...
OUTPUT_FILE="friends/jetfakes_lib_ele_incl_bveto_ortho_det_reg_test.json"
PLOT_OUTPUT="plots/09_02_eem_mme_2/jet_to_ele_fakerates_incl_bveto_ortho_det_reg_test"
mkdir -p ${PLOT_OUTPUT}
